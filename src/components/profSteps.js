...
class ProfSteps extends Component {
    constructor(props) {
        super(props);
    }
    render() {
                    ...
                    <Col xs={12}>
                        <div style={{ display: 'flex' }}>
                            <div style={{ display: 'flex', width: '35%' }}>
                                ...
                                {/* <div className="stepNo" style={{ backgroundColor: this.props.verifystep===1?"#1D2A64":"#EEEEEE", color: this.props.verifystep===1?"#FFFFFF":"#BFBFBF" }}>1</div> */}
                                <span style={{ paddingTop: '15px', paddingLeft: '15px', fontWeight: '700', color: this.props.verifystep === 1 ? "#1D2A64" : "#BFBFBF" }}>Verify Identity</span>
                                <div style={{ paddingTop: '10px', paddingLeft: '15px', paddingRight: '15px', width: '60%' }}>
                                    <hr style={{ width: 'auto' }} />
                                </div>
                            </div>
                            ...
                            <div style={{ display: 'flex', width: '45%' }}>
                                ...
                                <span style={{ paddingTop: '15px', paddingLeft: '15px', fontWeight: '700', color: this.props.verifystep === 2 ? "#1D2A64" : "#BFBFBF" }}>Employee Details</span>
                                <div style={{ paddingTop: '10px', paddingLeft: '15px', paddingRight: '15px', width: '60%' }}>
                                    <hr style={{ width: 'auto' }} />
                                </div>
                            </div>
