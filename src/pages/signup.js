...
import { IconLogo, IconEmployee } from '../assets/icon';

import logo from '../assets/logo-white.png';
import emplr from '../assets/emp1.png';
import suitcase from '../assets/Employee_Icon.png';
            ...
            <Container style={{ height: '100%' }}>
                <Row style={{ paddingTop: '10%' }}>
                    ...
                    <Col style={{ textAlign: 'start', paddingLeft: '50px' }} xs={5}>
                        ...
                        <h1>Employ Chain</h1>
                        <p>Ensuring a Secure Job Seeking Experience</p>
                        <img src={emplr} style={{ width: '55%' }} />
                    </Col>
                </Row>
            </Container>
        </div>
